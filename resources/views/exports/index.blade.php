                            ...
                            <tr class="hover:bg-slate-50" id="export-row-{{ $export->id }}">
                                ...
                                <td class="px-4 py-3">
                                    ...
                                    @elseif($export->status === 'processing')
                                        <span class="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium rounded-full bg-blue-100 text-blue-700"><i class="fas fa-spinner fa-spin text-[8px]"></i> Processing</span>
                                    ...
                                    @else
                                        <span class="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium rounded-full bg-red-100 text-red-700"><i class="fas fa-times text-[8px]"></i> Failed</span>
                                    @endif
                                </td>
