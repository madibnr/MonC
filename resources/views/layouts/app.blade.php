            ...
            <nav class="flex-1 px-3 py-4 sidebar-scroll overflow-y-auto">
                <div class="space-y-1">
                    ...
                    <a href="{{ route('exports.index') }}" 
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors {{ request()->routeIs('exports.*') ? 'bg-monc-accent text-white' : 'text-slate-300 hover:bg-monc-hover hover:text-white' }}">
                        <i class="fas fa-file-export w-5 text-center"></i>
                        <span>Export Clips</span>
                    </a>
                    
                    <a href="{{ route('snapshots.index') }}" 
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors {{ request()->routeIs('snapshots.*') ? 'bg-monc-accent text-white' : 'text-slate-300 hover:bg-monc-hover hover:text-white' }}">
                        <i class="fas fa-camera-retro w-5 text-center"></i>
                        <span>Snapshots</span>
                    </a>
